...
// This is the root component that Angular uses to bootstrap the app
...
// information about the decorated declaration. Decorators are a proposed
// feature in the next version of JavaScript (ES7), but they are implemented as
// part of TypeScript.
...
// An export declaration declares one or more exported module members. The exported members
